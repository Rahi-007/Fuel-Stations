...
const Page = () => {
  return (
    <div className="relative min-h-screen w-full overflow-hidden bg-zinc-950">
      ...
      <div className="absolute inset-0 bg-gradient-to-br from-zinc-950/78 via-zinc-950/62 to-cyan-950/28" />
      <div className="absolute inset-0 bg-gradient-to-t from-black/42 via-transparent to-black/18" />
      <div className="absolute inset-0 bg-[radial-gradient(ellipse_75%_55%_at_50%_-15%,rgba(34,211,238,0.075),transparent)]" />
      <div
      ...
      <div className="relative z-10 mx-auto flex min-h-screen max-w-6xl flex-col px-4 py-10 lg:flex-row lg:items-center lg:gap-12 lg:px-8">
        ...
        >
          <Link
            href="/"
            className="mb-8 inline-flex w-fit items-center gap-2 text-sm font-medium text-zinc-400 transition-colors hover:text-cyan-400"
          >
            <span className="flex h-9 w-9 shrink-0 items-center justify-center rounded-xl border border-white/10 bg-white/5 text-cyan-400">
